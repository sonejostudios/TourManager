...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tbt_monitor_menu = QToolButton(self.layoutWidget)
        self.tbt_monitor_menu.setObjectName(u"tbt_monitor_menu")
        self.tbt_monitor_menu.setMinimumSize(QSize(0, 31))
        self.tbt_monitor_menu.setPopupMode(QToolButton.ToolButtonPopupMode.InstantPopup)

        self.horizontalLayout_18.addWidget(self.tbt_monitor_menu)
        ...
        self.menubar.setGeometry(QRect(0, 0, 1708, 20))
...
#endif // QT_CONFIG(tooltip)
        self.tbt_monitor_menu.setText(QCoreApplication.translate("MainWindow", u"...", None))
#if QT_CONFIG(tooltip)
